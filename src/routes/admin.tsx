      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="text-white/40 max-w-xl text-lg">
            Welcome back, Alpha-Operator. Global systems are currently running
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            <GlassCard className="!p-0">
              <div className="p-6 border-b border-white/5 flex items-center justify-between">
                ...
                <span className="px-3 py-1 rounded bg-green-500/10 text-green-500 text-[9px] font-black uppercase tracking-widest">
                  Global Sync: Active
                </span>
              </div>
            ...
            <div className="bg-amber-500/5 border border-amber-500/20 rounded-3xl p-8 flex items-start gap-6">
              ...
              <div>
                ...
                <p className="text-white/50 text-sm leading-relaxed">
                  A new vulnerability has been detected in the OpenSSH protocol
                  (CVE-2026-X). AI Sentinels have already deployed patch v0.12.8
                  across all Tier 1 nodes. No action required.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <h3 className="font-display text-xl font-bold text-white uppercase tracking-tight px-2">
              Console Operations
            </h3>
...
function AdminAction({ label, color }: { label: string; color: string }) {
  ...
  return (
    <button
      className={`w-full text-left p-6 rounded-2xl border transition-all duration-300 flex items-center justify-between group ${colors[color]}`}
      data-magnetic="true"
    >
