      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="text-white/50 max-w-2xl mx-auto text-xl leading-relaxed">
            A distributed mesh of AI-powered sentinels spanning 24 regions
            globally. Instant threat suppression at the edge, before it even
            reaches your core.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              <div className="font-mono text-[11px] text-cyber/40 uppercase tracking-[0.4em] mb-4">
                Initialising Real-time Topology
              </div>
