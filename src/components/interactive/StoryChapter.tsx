  ...
  return (
    <section ref={ref} className="relative px-4 sm:px-10 py-12 sm:py-24">
      <div className="relative mx-auto w-full max-w-[1400px] overflow-hidden rounded-[40px] bg-black shadow-[0_50px_100px_-20px_rgba(0,0,0,0.9)] ring-1 ring-white/10">
        ...
        <motion.div style={{ y, scale }} className="absolute inset-0 h-[125%] w-full">
             <img
                src={image} 
                alt=""
        ...
        <div className="relative aspect-[16/10] min-h-[600px] lg:aspect-[21/9] pointer-events-none">
          ...
          >
            <div className={`flex items-center gap-4 text-[12px] uppercase tracking-[0.3em] text-cyber font-bold`}>
              <span className="font-mono bg-cyber/10 px-2 py-0.5 rounded backdrop-blur-md">{index}</span>
              <span className="h-px w-12 bg-cyber/40" />
              <span className="text-white/60">{eyebrow}</span>
            </div>
            
            <h2 className="font-display text-[clamp(2.5rem,6vw,5.5rem)] font-bold leading-[0.9] tracking-[-0.04em] text-white drop-shadow-[0_10px_40px_rgba(0,0,0,0.8)]" data-magnetic="true">
              {title}
            </h2>
            
            <p className="max-w-md text-[17px] leading-relaxed text-white/50" data-magnetic="true">
              {body}
            </p>
