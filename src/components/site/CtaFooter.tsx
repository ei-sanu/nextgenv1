      ...
      <div className="mx-auto max-w-6xl text-center relative">
        ...
        >
          ...
          <p className="mx-auto mt-10 max-w-xl text-[17px] leading-relaxed text-white/50">
            Provision your first AI sentinel in under sixty seconds. No
            friction, no lag — just absolute, autonomous protection for your
            entire digital stack.
          </p>

          <div className="mt-12 flex flex-wrap justify-center gap-5">
            <button
              className="group relative overflow-hidden rounded-full bg-white px-10 py-4 text-sm font-bold uppercase tracking-widest text-neutral-900 transition hover:scale-105 active:scale-95"
              data-magnetic="true"
            >
              Initialize Sentinel
            ...
            <button
              className="group flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-10 py-4 text-sm font-bold uppercase tracking-widest text-white backdrop-blur-md transition hover:bg-white/10"
              data-magnetic="true"
            >
              Security Docs
        ...
        <footer className="mt-48 flex flex-col items-center justify-between gap-8 border-t border-white/5 pt-12 text-[11px] font-bold uppercase tracking-[0.2em] text-white/30 md:flex-row">
          <div className="flex items-center gap-3">
            ...
            <span className="ml-4 border-l border-white/10 pl-4 lowercase font-normal italic tracking-normal text-white/20">
              © 2026 — absolute security for the global grid.
            </span>
          </div>
