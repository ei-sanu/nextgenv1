        ...
        <div className="flex items-center justify-between gap-10">
          ...
          >
            <div className="relative">
              ...
              <Shield
                className="relative h-6 w-6 text-cyber transition-transform group-hover:scale-110"
                strokeWidth={2.5}
              />
            </div>
            ...
            {links.map((l) => (
              <li key={l.label}>
                <Link
                  ...
                  data-magnetic="true"
                  activeProps={{
                    className: "!text-cyber !bg-cyber/5 !border-cyber/20",
                  }}
                >
            ...
            {!user ? (
              ...
              <div className="flex items-center gap-4 bg-white/5 border border-white/10 p-1 pl-4 rounded-full">
                <div className="flex flex-col items-start pr-2">
                  <span className="font-mono text-[9px] font-bold text-cyber uppercase tracking-tighter">
                    Authorized User
                  </span>
                  <span className="font-display text-[11px] font-bold text-white uppercase">
                    {user.username}
                  </span>
                </div>
                <button
